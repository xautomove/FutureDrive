    ...
    async start(nodes, edges) {
        ...
        try {
            ...
            const systemConfig = {
                ...
                workflowStatus: 'workflow_starting',
                workflowMessage: '工作流启动中',
                workflowUpdatedAt: new Date().toISOString(),
                taskStatus: GLOBALS.currentTaskContext?.mode ? 'starting' : 'idle',
                taskMessage: GLOBALS.currentTaskContext?.mode ? '任务链路启动中' : '等待任务选择',
                taskUpdatedAt: new Date().toISOString(),
                manualActuators: GLOBALS.manualActuatorState || {
                    frontLaser: false,
                    rearLaser: false,
                    warningLight: false,
                    hotMelt: false,
